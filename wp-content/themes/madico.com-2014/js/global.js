...
(function ($) {
	...
	if ($slideshow.length > 0) {
		...
		// slideshows
		head.js(["/wp-content/themes/madico.com/js/jquery.cycle.js", "/wp-content/themes/madico.com/js/jquery.backstretch.min.js"], function () {
			...
			$('.backstretch', $slideshow).each(function () {
	...
	if ($('.main table').length > 0) {
		$('.main table').wrap('<div style="overflow: auto; margin-top: 20px;" />');
	}
