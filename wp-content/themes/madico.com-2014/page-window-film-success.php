        ...
        <div class="row collapse">
            <div class="small-12 columns">
                <div class="item" style="display:inline;">
                    <h1>Success!</h1>
                    <p>We have successfully received your information.<br/> We will be in touch to further discuss the endless benefits of SafetyShield®
                    </p>
                </div>
            </div>
        </div>
