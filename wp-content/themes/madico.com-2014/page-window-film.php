<?php 
/**
 * Template Name: Safety Shield Window Film
 *
    ...
    <head>
        ...
        <style>
            ...
            @media only screen and (min-width: 40.063em) {
                ...
                .logo { padding: 0em; text-align: center; }
            ...
            @media only screen and (min-width: 64.063em) {
                ...
                .logo { margin-left: 8.33333%;padding-left: .9375rem; text-align: left;}
    ...
    <body>
        ...
        <div class="row">
            <div class="fadein small-12">
                ...
                <img src="/img/house-landing-page.jpg"/>
            </div>
        </div>
        ...
        <div class="row collapse">
            <div class="show-for-medium medium-6 columns">
                <div class="item" style="margin-left:19%;">
                    <h3 style="">Safety And Security Window Films From Madico: Performance You Can Trust.</h3>
                    <ul style="margin:0; padding:0;">
                        <li style="margin-left:1em;">Designed to fight today’s threats, from crime and vandalism to storms and explosions.</li>
                        <li style="margin-left:1em;">Extensively tested to have met or exceeded the requirements of more U.S. and international standards than any other safety and security films, including the U.S. Consumer Product Safety Commission and Underwriters Laboratories.</li>
        ...
        <div class="row collapse">
            <div class="small-12 medium-6 columns"><img src="/img/dm16-land-grfx-autofilm.jpg" /></div>
            <div class="small-12 medium-6 columns">
                <div class="item">
                    <h3>Every shade of excellence.</h3>
                    <p>Our glass safety film is available in a wide range of styles and grades.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row collapse">
            ...
            <div class="small-12 medium-6 columns show-for-medium"><img src="/img/bomblast-page-premier-partner.jpg" /></div>
