...
$events = array(
	...
	array(
		...
		"type"		=> 'safety',
		"y"			=> 330,
		"html"		=> "Madico collaborates with Agion&reg; Technologies to develop an Anti-Microbial laminate."
	),
	array(
		"year"		=> '2005',
		"type"		=> 'window',
	...
	array(
		...
		"type"		=> 'madico',
		"y"			=> 365,
		"html"		=> "Madico expands the Window Film business with the purchase of Solar Matrix."
	)
);

?>

<link type="text/css" href="js/ui-lightness/jquery-ui-1.8.6.custom.css" rel="stylesheet" />
<!--[if lte IE 7]>
	...
	<div id="timeline-holder" class="clearfix">
		...
		<div id="legend" class="not-flipped">
			<div class="default">
				<ul id="types" class="clearfix">
					<li><img src="images/legend_madico.gif" alt="Madico Corporate" /></li>
					<li><img src="images/legend_window.gif" alt="Energy Conservation - Window Film" /></li>
					<li><img src="images/legend_specialty.gif" alt="Renewable Energy - Specialty Film" /></li>
					<li><img src="images/legend_safety.gif" alt="Safety Film" /></li>
					<li><img src="images/legend_security.gif" alt="Asset Security" /></li>
				</ul>
				<p>Roll over any icon on the timeline for details.</p>
			</div>
			<?php for($i = 0; $i < count($events); $i++) {
			?>
				<div class="detail <?php echo $events[$i]['type'];?> <?php if($events[$i]['year'] >= 1980) echo 'flipped'; else echo 'not-flipped'; ?>" id="event-<?php echo $i; ?>" style="background: #F1F1F1 url(images/icons/<?php echo $events[$i]['type'];?>-event.png) no-repeat 6px 6px;">
		...
		<div id="timeline-box" class="clearfix">
			...
			<div id="interactive" class="clearfix">
				...
				for($i = 0; $i < count($events); $i++) {
				 ...
				 ?>	style="left:<?php echo $percent;?>%;<?php
						...
						if( !empty($events[$i]['type']) && isset($events[$i]['type'])) {
							echo '<image src="images/icons/' . $events[$i]['type'] . '.png" />';
						}
						?>
						</a>
				...
				<img id="timeline" src="images/graph.png" width="894" height="298" />
				<div id="xlabels">
					<?php
						$counter = 0;
