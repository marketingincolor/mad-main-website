<?php 
/**
 * Template Name: ClearPlex Landing Page A
 *
...
<html lang="en">
    <head> 
        ...
        <style>
            ...
            @media(max-width:1024px){
              ...
              .form-container{margin: 30px auto 0}
              .images .item{
              	padding:5% 10%;
              }
              .images .item p{
    ...
    <body>
        ...
        function navSlideDown(){
          var heroHeight = $('.hero').outerHeight() + $('.header-row').outerHeight() + $('.form-section').outerHeight();
