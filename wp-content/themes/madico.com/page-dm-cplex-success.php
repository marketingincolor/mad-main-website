<?php 
/**
 * Template Name: DM ClearPlex Landing Success Page
 *
    ...
    <body>
        ...
        <div class="row">
            <div class="header small-12 medium-8 medium-offset-1 columns">
             <img src="/img/cplex-land-logo.png">
            </div>
        </div>
        
        <div class="row">
            <div class="small-12">
                <img src="/img/cplex-success-slide-car.jpg"/>
            </div>
        </div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
                   ...
                   <div class="sm-meta" style="position:relative; display:inline-block; vertical-align:middle;" >
                    <a href="https://www.instagram.com/clearplex" class="ig-b- ig-b-16"><img src="/img/instagram-logo.jpg" alt="Instagram" /></a>
