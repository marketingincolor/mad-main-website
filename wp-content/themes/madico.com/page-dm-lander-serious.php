<?php 
/**
 * Template Name: DM 16 Serious Muscle Landing Page
 *
        ...
        <div class="row collapse">
            ...
            <div class="small-12 medium-6 columns">
                <div class="item">
                    ...
                    <h2>Charcool<span class="mark">&reg;</span> | Black Pearl<span class="mark">&reg;</span> | Onyx<span class="mark">&reg;</span> | Wincos<span class="mark">&reg;</span> | Charcoal</h2>
                    <p>From durability to easy installation, our automotive films offer unparalleled performance and style.</p>
                </div>
            </div>
        </div>

        <div class="row collapse">
            <div class="hide-for-medium small-12 columns"><img src="/img/dm16-land-grfx-car.jpg" /></div>
            <div class="small-12 medium-6 columns">
                <div class="item">
                    <h3>When it comes to paint protection, we've left no stone unturned.</h3>
                    <p>We've perfected our Invisi-Film Paint Protection film to provide superior invisible protection, unrivaled durability, total ease of installation and an easy boost to your bottom line.</p>
                </div>
            </div>
            <div class="show-for-medium medium-6 columns"><img src="/img/dm16-land-grfx-car.jpg" /></div>
        </div>
