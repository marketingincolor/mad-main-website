<?php 
/**
 * Template Name: Madico Experience Success Page
 *
...
<html lang="en">
    <head>
        ...
        <style>
            ...
            /*======= New Styles ======*/
            .hero{
                background-image:url(/img/mad-cc-success-bgnd.jpg);
        ...
        <section class="hero">
            <div class="row">
                <div class="header small-12 medium-8 medium-offset-2 columns">
                    <img src="/img/mad-cc-logo-blue.png">
                    <br>
                    <img src="/img/mad-cc-success-icon.png" width="136" alt="Check!" />
                    <h2 class="hero-text">Well Done!</h2>
                    <aside class="yellow-underline"></aside>
                    <p>We have received your information and someone will contact you soon. Thank you for your interest in learning more about the New Madico Experience.</p>
