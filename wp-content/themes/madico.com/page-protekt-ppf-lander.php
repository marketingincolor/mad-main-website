...
<html lang="en">
    <head> 
        ...
        <style>
            ...
            .hero{
            	background-image:url(/img/protekt-hero.jpg);
            ...
            .features{
            	background-image: url(/img/protekt-img-car.jpg);
            	background-position: center center;
            	background-repeat: no-repeat;
            	background-size: cover;
            	padding: 8% 0;
            ...
            .features .features-list p, .car .features-list p, .road .features-list p { padding-left:20px; position:relative; top:-5px; margin:0; }
            .car{
            	background-image: url(/img/protekt-img-bike.jpg);
            	background-position: center center;
            	background-repeat: no-repeat;
            	background-size: cover;
            	padding: 8% 0;
    ...
    <body>
        ...
        <section class="features">
            <div class="row">
                <img src="/img/protekt-img-car-mobile.jpg" alt="A Smart Investment" class="show-for-small-only">
        ...
        <section class="car">
            <div class="row">
                <img src="/img/protekt-img-bike-mobile.jpg" alt="Protekt PPF Motorcycle" class="show-for-small-only">
        ...
        <section class="testimonials">
        	<div class="row">
        		<img src="/img/protekt-img-car-alt-mobile.jpg" alt="Protekt PPF testimonials" class="show-for-small-only">
                <div class="medium-5 medium-offset-7 columns end">
                    <img src="/img/protekt-quote-icon.png" alt="Testimonial Quote">
                </div>
                <div class="medium-5 medium-offset-7 columns end">
        ...
        <div class="protekt-form" id="protekt-form">
        	<div class="row">
        	  <div class="medium-offset-2 medium-8 large-6 large-offset-3 columns text-center">
        	    <img src="/img/protekt-form-icon.png" alt="">
        	    <h3>With Protekt PPF, your sales will shine on!</h3>
        	    <p class="fdesc">Protekt PPF is the clear choice to grow your business. Complete the form below to get started.</p>
                <?php gravity_form(36, false); /* staging */ ?>
        ...
        <section class="footer">
        	<div class="row">
                <div class="small-12 columns text-center">
                    <img src="/img/protekt-logo-header.png" alt="Protekt PPF Logo" width="330">
            	    <p><a href="/window-film/automotive/protekt-paint-protection-film/">madico.com</a>&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;<a href="/window-film/privacy-policy/">Privacy Policy</a></p>
