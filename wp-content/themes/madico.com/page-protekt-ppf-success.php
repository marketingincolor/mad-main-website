...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .hero{
                background-image:url(/img/protekt-hero-alt.jpg);
    ...
    <body>
        ...
        <div class="row">
            <div class="header small-12 columns" style="text-align:center;">
             <img src="/img/protekt-logo-header.png" width="360">
            </div>
        </div>
                    ...
                    <div class="small-12 small-centered">
                        ...
                        <div style="position:relative; margin-bottom:20px;">
                            <div class="sm-meta" style="position:relative; display:inline-block; vertical-align:middle; padding:10px 10px 10px 0px;" >
                                <a href="https://www.facebook.com/MadicoInc" target="_blank" class="sm-ico"><img src="/img/protekt-ico-fb.png" alt="Facebook" width="54" /></a>
                            </div>

                            <div class="sm-meta" style="position:relative; display:inline-block; vertical-align:middle; padding:10px;" >
                                <a href="https://twitter.com/MadicoInc" target="_blank" class="sm-ico"><img src="/img/protekt-ico-tw.png" alt="Twitter" width="54" /></a>
                            </div> 

                            <div class="sm-meta" style="position:relative; display:inline-block; vertical-align:middle; padding:10px;" >
                                <a href="https://www.linkedin.com/company/madicoinc/" target="_blank" class="sm-ico"><img src="/img/protekt-ico-li.png" alt="LinkedIn" width="54" /></a>
                            </div>

                            <div class="sm-meta" style="position:relative; display:inline-block; vertical-align:middle; padding:10px;" >
                                <a href="https://plus.google.com/+MadicoInc" target="_blank" class="sm-ico"><img src="/img/protekt-ico-gp.png" alt="Google+" width="54" /></a>
                            </div>

                            <div class="sm-meta" style="position:relative; display:inline-block; vertical-align:middle; padding:10px;" >
                                <a href="https://youtube.com/c/MadicoInc" target="_blank" class="sm-ico"><img src="/img/protekt-ico-yt.png" alt="YouTube" width="54" /></a>
                            </div>
                        </div>
                        </div>
                    </div>
        ...
        <section class="footer">
            <div class="row">
                <div class="small-12 columns text-center">
                    <p><a href="/window-film/automotive/protekt-paint-protection-film/">madico.com</a>&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;<a href="/privacy-policy/">Privacy Policy</a></p>
